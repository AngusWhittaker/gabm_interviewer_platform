...
pages_urlpatterns = [
  ...
  re_path(r'^upload-bulk/$', pages_views.upload_bulk, name='upload_bulk'),
  re_path(r'^download-bulk$', pages_views.download_bulk, name='download_bulk'),
  ...
  re_path(r'^download_reflections/(?P<participant_username>[^/]+)/(?P<script_v>[^/]+)/$', pages_views.download_reflections, name='download_reflections'),
